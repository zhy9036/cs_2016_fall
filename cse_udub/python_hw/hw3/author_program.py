...
if __name__ == '__main__':
    ...
    dir_name = read_directory_name(prompt)
    ...
    mystery_signature.append(author_functions.average_word_length(text))
    ...
    mystery_signature.append(author_functions.average_sentence_length(text))
